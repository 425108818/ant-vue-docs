import{_ as s,c as n,o as a,Q as l}from"./chunks/framework.3ad8d30d.js";const d=JSON.parse('{"title":"定制主题","description":"","frontmatter":{},"headers":[],"relativePath":"guide/theme.md","filePath":"guide/theme.md","lastUpdated":1697191842000}'),p={name:"guide/theme.md"},o=l(`<h1 id="定制主题" tabindex="-1">定制主题</h1><h2 id="_1、修改组件变量" tabindex="-1">1、修改组件变量</h2><p>在<code>styles</code>项目中新建<code>theme.less</code>文件，再到<code>main.ts</code>引入该文件即可修改，内容如下。<br><code>--ur-color-1</code>变量为保持与前端内部规范而命名，在此赋值引入项目内的<code>default.less</code>文件变量进行覆盖即可。</p><div class="language-css vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">css</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#B392F0;">:root</span><span style="color:#E1E4E8;"> {</span></span>
